...
このプロジェクトでは、Dependabotを使用してMaven依存関係を自動的に最新に保っています。

### 特徴

- **自動更新**: 毎週月曜日の09:00（日本時間）に依存関係をチェック
- **セキュリティアップデート**: 脆弱性が発見された場合の自動プルリクエスト作成
- **日本語対応**: 設定とドキュメントは日本語で記述

### 詳細情報

Dependabotの設定詳細については、[Dependabot設定ドキュメント](docs/DEPENDABOT.md)をご確認ください。
